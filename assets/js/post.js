	...
	[6], {
		...
		22: function(t, e, n) {
			...
			function O() {
				...
				f.parent().attr("viewBox", "0 0 ".concat(t, " ").concat(t)), f.attr("stroke-width", n), f.attr("r", e - (n - 1)),
					f.attr("cx", e), f.attr("cy", e), p = 2 * e * Math.PI, f[0].style.strokeDasharray = "".concat(p, " ").concat(p),
					f[0].style.strokeDashoffset = p
			}

			function M() {
				f = o()(".js-progress"), x(), O(), j(), setTimeout(function() {
			...
			o()(document).ready(function() {
				...
				c()(".js-post-content"),
					...
					}(), v(1e3), i.length > 0 && (i.on("init", function() {
					...
					}), Object(r.a)(".js-zoomable"), window.addEventListener("scroll", g, {
						passive: !0
